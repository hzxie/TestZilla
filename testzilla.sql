...
--
-- Host: localhost
-- Generation Time: Feb 28, 2015 at 10:09 上午
...
(1000, 1001, '1.0 Beta', 5, 4, 3, '2015-01-22 08:05:00', 1001, 'Bug #1000', '# Marked in browser\\n\\nRendered by **marked**.', NULL),
(1001, 1001, '1.0 Beta', 12, 1, 2, '2015-02-03 08:05:00', 1000, 'Bug #1001', 'This is the *first* editor.\r\n------------------------------\r\n\r\nJust plain **Markdown**, except that the input is sanitized:\r\n\r\nand that it implements "fenced blockquotes" via a plugin:\r\n\r\n"""\r\nDo it like this:\r\n\r\n1. Have idea.\r\n2. ???\r\n3. Profit!\r\n"""', NULL),
(1002, 1000, '1.0 Beta', 2, 1, 1, '2015-02-03 12:11:20', 1001, 'Bug #1002', '# Bug #1002 Description\\nSome Text Here...', '');
...
(1000, 1001, '2014-12-30 16:00:00', 1, NULL),
(1001, 1002, '2014-12-30 16:00:00', 1, NULL);
...
(1001, 'CourseOcean', 'http://www.courseocean.com/img/logo.png', 1, '1.0 Beta', 1001, 'IE 7+, Firefox, Chrome or Safari', 'http://www.CourseOcean.com/', 'IT training platform based on O2O business model.'),
(1002, 'Test', 'http://www.baidu.com/img/bd_logo1.png', 3, 'Test', 1001, 'Test', 'Test', 'Test');
...
(1000, 'Administrator', '785ee107c11dfe36de668b1ae7baacbb', 3, 'Administrator', 'admin@testzilla.org', 'China', 'Zhejiang', 'Hangzhou', '+86-571-12345678', 'http://testzilla.org', 0, 1),
...
(1002, 'testzilla', '785ee107c11dfe36de668b1ae7baacbb', 2, 'TestZilla', 'support@testzilla.org', 'China', 'Zhejiang', 'Hangzhou', '+86-571-12345678', 'http://testzilla.org', 0, 1);
...
ALTER TABLE `tz_points_rules`
 ADD PRIMARY KEY (`points_rule_id`), ADD UNIQUE KEY `points_rule_slug` (`points_rule_slug`);
...
--
ALTER TABLE `tz_points_logs`
MODIFY `points_log_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1002;
--
...
--
ALTER TABLE `tz_products`
MODIFY `product_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1003;
--
