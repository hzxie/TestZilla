...
/**
 * @Author: Haozhe Xie
 * @Date:   2020-01-16 14:37:19
 * @Last Modified by:   Haozhe Xie
 * @Last Modified time: 2020-01-16 14:42:23
 */
...
class AccountsController extends BaseController {
    ...
    public function verifyEmailAction() {
        ...
        $userService    = ServiceFactory::getService('UserService');
        $isSuccessful   = $userService->verifyEmail($email, $token);

        $this->tag->prependTitle($this->localization['accounts.verify-email.title']);
        $this->view->setVar('isSuccessful', $isSuccessful);
    }
